...
const stackContent = {
  pt: {
    ...
    categories: [
      ...
      { label: "Ferramentas", badgeClass: "badge-tools", items: ["Git", "GitHub", "Node.js", "Power BI", "Docker (aprendendo)"] },
  ...
  en: {
    ...
    categories: [
      ...
      { label: "Tools", badgeClass: "badge-tools", items: ["Git", "GitHub", "Node.js", "Power BI", "Docker (learning)"] },
      { label: "Design", badgeClass: "badge-design", items: ["Adobe Photoshop", "Sony Vegas"] },
    ],
  },
};
