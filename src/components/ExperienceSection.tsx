  ...
  pt: {
    ...
    experiences: [
      ...
      },
      {
        ...
        company: "Freelancer",
        period: "2020 - Atual",
        desc: "Desenvolvimento de sistemas web, sob demanda e para estudos pessoais. Foco em soluções práticas e eficientes para clientes diversos.",
      },
      {
        role: "Manutenção e Suporte T.I",
        company: "Freelancer",
        period: "2021 - Atual",
        desc: "Manutenção e suporte técnico para computadores, cabeamento de redes, configuração de servidores domésticos, suporte remoto para clientes com dificuldades técnicas.",
      },
      {
        role: "Instrutor de Tecnologia de Cursos Técnicos",
        company: "Grau Técnico",
        period: "2024 - 2025",
        desc: "Monitoramento de alunos, preparação de aulas práticas, suporte a estudantes com dificuldades, foco em tecnologia aplicada ao mercado de trabalho.",
      },
      {
  ...
  en: {
    ...
    experiences: [
      ...
      },
      {
        ...
        company: "Freelancer",
        period: "2020 - Present",
        desc: "Development of web systems, on demand and for personal studies. Focus on practical and efficient solutions for diverse clients.",
      },
      {
        role: "IT Maintenance and Support",
        company: "Freelancer",
        period: "2021 - Present",
        desc: "Maintenance and technical support for computers, network cabling, configuration of home servers, remote support for clients with technical difficulties.",
      },
      {
        role: "Technical Course Technology Instructor",
        company: "Grau Técnico",
        period: "2024 - 2025",
        desc: "Monitoring students, preparing practical lessons, supporting students with difficulties, focusing on technology applied to the job market.",
      },
      {
